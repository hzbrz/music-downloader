...
function  getOutput(item) {
    ...
    // Build output string
    var output = '<li style="list-style: none; border-top: 2px dashed; border-bottom: 2px dashed;">' +
...
function getLinks(event) {
    ...
    var list_link = '<li style="list-style: none;">' +
            '<iframe style="width:230px;height:60px;border:0;overflow:hidden;" scrolling="no" src="//www.youtubeinmp3.com/widget/button/?video='+link+'"&color=c91818></iframe>' +
            '</li>' +
            '';
